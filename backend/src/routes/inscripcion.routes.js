...
router.post("/",authorizationMw.isOwnerOrAdmin, inscripcionController.createInscripcion);
router.put("/:id",authorizationMw.isOwnerOrAdmin, inscripcionController.updateInscripcion);
router.delete("/:id",authorizationMw.isOwnerOrAdmin, inscripcionController.deleteInscripcion);
